...
<body>
    ...
    {{-- Your header/navbar here if any --}}

   

    {{-- Your footer here if any --}}
  ...
  <body>
        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="subcategories">
        ...
        <div class="main-header">
          ...
          >
            <div class="container-fluid">
              <nav class="navbar navbar-header-left navbar-expand-lg navbar-form nav-search p-0 d-none d-lg-flex w-100 justify-content-center">
    ...
    @csrf
    <button type="submit" class="inline-flex items-center px-3 py-1 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-md transition">
